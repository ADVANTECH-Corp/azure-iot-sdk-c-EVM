...
#if defined(_WIN64)
#define CC_KEY unsigned long long
#else
#define CC_KEY unsigned long
#endif
...
ADVCC_EXPORT int ADVCC_CALL Seq_GetAmountWithKey(SeqHandler handler, CC_KEY key);

ADVCC_EXPORT int ADVCC_CALL Seq_PeekWithKey(SeqHandler handler, void *data, CC_KEY key);
...
ADVCC_EXPORT int ADVCC_CALL Seq_PushHeadWithKey(SeqHandler handler, void *data, int dataSize, CC_KEY key);
ADVCC_EXPORT int ADVCC_CALL Seq_PushTailWithKey(SeqHandler handler, void *data, int dataSize, CC_KEY key);
ADVCC_EXPORT int ADVCC_CALL Seq_PopWithKey(SeqHandler handler, void *data, CC_KEY key);
...
ADVCC_EXPORT int ADVCC_CALL Seq_PushHeadWithKeyBlocking(SeqHandler handler, void *data, int dataSize, CC_KEY key);
ADVCC_EXPORT int ADVCC_CALL Seq_PushTailWithKeyBlocking(SeqHandler handler, void *data, int dataSize, CC_KEY key);
ADVCC_EXPORT int ADVCC_CALL Seq_PopWithKeyBlocking(SeqHandler handler, void *data, CC_KEY key);
