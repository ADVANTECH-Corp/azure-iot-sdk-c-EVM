...
ADVJSON_EXPORT void ADVJSON_CALL JSON_Get(JSONode *json, const char *path, char *result, size_t size);
ADVJSON_EXPORT void ADVJSON_CALL JSON_Cmd(JSONode *json, const char *path, char *assign, size_t size);
