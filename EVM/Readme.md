...
1. Copy the folder of **EVM** with the generated code into the source folder **azure-iot-sdk-c-pnp** .
...
1. Open the `CMakeLists.txt` in the **azure-iot-sdk-c-pnp** folder. Include the **EVM** folder so that it will be built together with the Device SDK. Add the line below to the end of the file.
    ```txt
